...
public class TeacherLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(user!=null){
            finish();
            startActivity(new Intent(TeacherLogin.this,Teacherdb.class));
        }

        signup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(TeacherLogin.this,TeacherReg.class));
            }
        });
        ...
        firebaseAuth.signInWithEmailAndPassword(name, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    Intent idb=new Intent(TeacherLogin.this,Teacherdb.class);
                    startActivity(idb);
