    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(TeacherReg.this, TeacherLogin.class));
            }
        });
                    ...
                    firebaseAuth.createUserWithEmailAndPassword(user_email, user_pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(TeacherReg.this, "Registration Successful", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(TeacherReg.this,Teacherdb.class));
                            } else {
                                Toast.makeText(TeacherReg.this, "Registration Failed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
